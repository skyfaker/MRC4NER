...
def train():
    ...
    dev_dataloader = DataLoader(dev_dataset, batch_size=32, shuffle=True, collate_fn=custom_collate)
    #
    ...
    custom_model = MRC_NER_Model(network, tokenizer, Device,
                                 train_dataloader=train_dataloader,
                                 dev_dataloader=dev_dataloader
                                 )

    custom_model.train(epoch_num=30, lr=1e-5)
    print('Train Done')
